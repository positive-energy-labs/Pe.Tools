...
| Peco repo workbench       | `source/pe-tools/apps/pe-code/`                                                                                                                                        | TypeScript/Node repo/dev CLI, agent TUI, and workbench web adapter exposed as `peco`; wraps SDK proof commands with Pea status/log hooks plus Pea black-box feedback tools.                                   | Peco owns repo-source posture, product hooks, and skills; SDK `pe-revit` owns Revit live/test mechanics. Keep repo-source posture out of Pea.                                                                                       |
...
| Dev CLI and proof tooling | `source/Pe.Dev.Cli/`, SDK `pe-revit`, `BUILD.md`                                                                                                                       | SDK `pe-revit` owns Revit proof lanes; repo-local `pe-dev` owns Pea/Peco source linking, web dev supervision, and automation commands.                                                                                                | Developer/operator tooling only; not a product semantic layer.                                                                                                                                                                      |
