...
| Host contracts            | `source/Pe.Shared.HostContracts/Operations/HostOperationsCatalog.cs`                                                                                                   | Canonical operation catalog, request/response DTOs, routes, metadata, the generated TypeScript client slice, generated TypeScript types and zod boundary schemas in `@pe/host-generated`, and hand-maintained .NET client contracts. | Stable public contract layer for callers; C# stays the type authority while generated TS types/zod schemas validate the web boundary. Examples and metadata steer Pea/UI/CLI instead of prompt lore.                                 |
