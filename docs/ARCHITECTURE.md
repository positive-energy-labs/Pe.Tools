...
| Dev CLI and proof tooling | `source/Pe.Dev.Cli/`, SDK `pe-revit`, `BUILD.md`                                                                                                                       | SDK `pe-revit` owns Revit proof lanes; repo-local `pe-dev` owns codegen, Pea/Peco source linking, and automation commands.                                                                                                | Developer/operator tooling only; not a product semantic layer.                                                                                                                                                                      |
