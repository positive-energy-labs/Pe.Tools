...
export const hostOperations = {
  ...
  "revit.apply.parameters-service-cache.refresh": {
    key: "revit.apply.parameters-service-cache.refresh",
    requestTypeName: "NoRequest",
    responseTypeName: "ParametersServiceCacheData",
    displayName: "Refresh Parameters Service Cache",
    description:
      "Refresh the global APS Parameters Service cache through the connected Revit runtime.",
    searchTerms: ["aps", "parameters", "cache", "refresh", "parameter-service"],
    intent: "Mutate",
    requiresActiveDocument: false,
    costTier: "Mutation",
    visibility: "EscalationVisible",
