 ...
 * so we use the Tailwind typography plugin (`prose`) tuned to the Lens palette: flat sans
 * headings, PE-blue links, square inline-code chips on paper-2, backtick pseudo-content stripped.
 *
...
export const PROSE_CLASS = [
  ...
  "prose-headings:font-sans prose-headings:text-[1em] prose-headings:font-semibold prose-headings:text-[var(--basalt)] prose-headings:mt-[0.9em] prose-headings:mb-[0.35em]",
  "prose-a:text-[var(--pe-blue)] prose-a:underline prose-a:underline-offset-2",
  // Code = data surface: hard corners per the radius law.
  "prose-code:rounded-none prose-code:border-[0.5px] prose-code:border-[var(--line)] prose-code:bg-[var(--paper-2)] prose-code:px-[5px] prose-code:py-px prose-code:text-[12.5px] prose-code:font-normal",
  "prose-code:before:content-none prose-code:after:content-none",
  "prose-pre:rounded-none prose-pre:border-[0.5px] prose-pre:border-[var(--line)] prose-pre:bg-[var(--paper-2)] prose-pre:text-[var(--basalt)]",
].join(" ");
