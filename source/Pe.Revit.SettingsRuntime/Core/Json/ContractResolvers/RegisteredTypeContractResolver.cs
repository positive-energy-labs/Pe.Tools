...
namespace Pe.Revit.SettingsRuntime.Core.Json.ContractResolvers;

public class RegisteredTypeContractResolver(JsonTypeSchemaBindingRegistry? bindingRegistry = null)
    : OrderedContractResolver {
    private readonly JsonTypeSchemaBindingRegistry _bindingRegistry =
        bindingRegistry ?? JsonTypeSchemaBindingRegistry.Shared;
