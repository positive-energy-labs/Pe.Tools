...
using InternalScheduleFieldFormatSpec = Pe.Revit.DocumentData.Schedules.Runtime.Fields.ScheduleFieldFormatSpec;
using InternalScheduleFieldSpec = Pe.Revit.DocumentData.Schedules.Runtime.Fields.ScheduleFieldSpec;
using InternalScheduleFilterSpec = Pe.Revit.DocumentData.Schedules.Runtime.Filters.ScheduleFilterSpec;
using InternalScheduleSortGroupSpec = Pe.Revit.DocumentData.Schedules.Runtime.SortGroup.ScheduleSortGroupSpec;
using InternalScheduleTitleStyleSpec = Pe.Revit.DocumentData.Schedules.Runtime.TitleStyle.ScheduleTitleStyleSpec;

namespace Pe.Revit.DocumentData.Schedules.Runtime;

public static class ScheduleProfileAdapters {
