...
public class ExtrusionSnapshot {
    ...
    public List<ConstrainedRectangleExtrusionSnapshot> Rectangles { get; set; } = [];
    public List<ConstrainedCircleExtrusionSnapshot> Circles { get; set; } = [];
}
...
/// </summary>
public class ConstrainedRectangleExtrusionSnapshot {
...
/// </summary>
public class ConstrainedCircleExtrusionSnapshot {
    public string Name { get; init; } = string.Empty;
    public bool IsSolid { get; init; }
    public double StartOffset { get; init; }
    public double EndOffset { get; init; }
