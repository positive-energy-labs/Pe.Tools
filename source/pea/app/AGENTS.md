...
| **dev-agent**                  | Pe.Tools repo coding agent built on Mastra Harness/Workspace primitives.                                                                                         |
...
- Keep dev-agent source-work behavior narrow and explicit unless a product requirement demands a broader override.
- Keep dev-agent skills in normal project-scoped Mastra-compatible skill locations for this repo. Keep installed Pea skills under `.pea/skills` only.
